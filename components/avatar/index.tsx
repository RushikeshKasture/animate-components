...
export default function AvatarComponent() {
  return (
    <div className="flex flex-col p-4 m-4 bg-blue-200">
      <p className="p-6">Avatar Styles</p>
      <div className="grid grid-cols-4 gap-6">
        {["default", "square", "circle", "bordered", "gradient", "shadow"].map(
          (item, index) => (
      ...
      <p className="p-6">Avatar without Image</p>
      <div className="grid grid-cols-4 gap-6">
        {["default", "square", "circle", "bordered", "gradient", "shadow"].map(
          (item, index) => (
            <div className="flex flex-col items-center gap-2" key={index}>
      ...
      <p className="p-6">Avatar with Animations</p>
      <div className="grid grid-cols-4 gap-6">
        {[
          "bounce",
          "flip",
