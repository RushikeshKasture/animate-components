...
> = {
  ...
  rounded: {
    ...
    track:
      "relative h-3 w-full grow overflow-hidden rounded-full bg-secondary/40",
  ...
  shadow: {
    root: "relative flex w-full touch-none select-none items-center",
    track:
      "relative h-2 w-full grow overflow-hidden rounded-full bg-secondary/30 shadow-inner",
  ...
  neon: {
    ...
    value:
      "text-cyan-500 text-sm font-bold",
  },
  material: {
    root: "relative flex w-full touch-none select-none items-center",
    track:
      "relative h-1 w-full grow overflow-hidden rounded-full bg-secondary/40",
    range: "absolute h-full bg-primary",
    thumb:
  ...
  retro: {
    root: "relative flex w-full touch-none select-none items-center",
    track:
      "relative h-3 w-full grow overflow-hidden bg-amber-100 border-2 border-amber-800",
  ...
  cyberpunk: {
    root: "relative flex w-full touch-none select-none items-center",
    track:
      "relative h-3 w-full grow overflow-hidden bg-black border-2 border-yellow-400",
    range:
  ...
  brutalist: {
    root: "relative flex w-full touch-none select-none items-center",
    track:
      "relative h-4 w-full grow overflow-hidden bg-gray-300 border-2 border-black",
  ...
  skeuomorphic: {
    ...
    range:
      "absolute h-full bg-gradient-to-b from-blue-400 to-blue-600 border-r border-gray-500",
    thumb:
  ...
  (
    ...
    return (
      <div className="w-full space-y-2">
        ...
        {showValue && (
          <motion.div
            className={cn("text-center text-sm", styles.value, valueClassName)}
            // animate={
            //   animationType === "pulse"
            //     ? {
            //         scale: [1, 1.05, 1],
